...
// hid descriptor for usb high speed
static unsigned char ipod_hid_report_hs[] = {
...
// hid descriptor for usb full speed
static unsigned char ipod_hid_report_fs[] = {
	0x06, 0x00, 0xff, 0x09, 0x01, 0xa1, 0x01, 0x75, 0x08, 0x26, 0x80, 0x00,
...
// https://github.com/oandrew/ipod-gadget/issues/32
	...
	.rpt_desc = {
		...
		.wDescriptorLength = cpu_to_le16(sizeof(ipod_hid_report_fs))
	}
#else
	.desc = {{
		.bDescriptorType = HID_DT_REPORT,
